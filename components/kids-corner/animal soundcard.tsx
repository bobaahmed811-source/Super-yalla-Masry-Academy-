...
import { getAnimalSoundFlow } from '@/ai/flows/animal-sound-flow'; // تأكدي أن المسار يطابق ملف الـ Flow
...
export default function AnimalSoundCard({
  ...
  return (
    <>
      ...
      {error && <p className="text-red-400 text-center mt-1 text-xs">{error}</p>}
